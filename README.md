...
- 🖼️ **โลโก้องค์กร (หลังบ้านเท่านั้น):**
  - อัปโหลดไฟล์ PNG/JPG/JPEG ผ่าน popup: ลากวาง, เลือกไฟล์จากเครื่อง, วางจากคลิปบอร์ด (Ctrl+V) หรือดึงจากลิงก์ภาพ
  - เครื่องมือครอบตัด: ย่อ/ขยาย, ปรับความเอียง, ลากจัดตำแหน่ง, จัดกึ่งกลาง, เลือกรูปทรงกรอบและขนาดผลลัพธ์
  - บีบอัดอัตโนมัติให้ไม่เกิน 200 KB พร้อมแสดงขนาดไฟล์ก่อนบันทึก · เก็บไฟล์ในฐานข้อมูลและเสิร์ฟผ่าน `/api/branding/logo`
- 🎨 **Liyon Design System:**
