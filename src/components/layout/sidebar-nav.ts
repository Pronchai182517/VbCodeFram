import { LayoutDashboard, Users, Settings, Layers, Newspaper, UserCheck, GraduationCap, FileCheck, CalendarDays, type LucideIcon } from "lucide-react";
...
export const sidebarGroups: NavGroup[] = [
  ...
  {
    label: "personnel.nav",
    items: [{ title: "personnel.nav", href: "/admin/personnel", icon: UserCheck, permission: PERSONNEL_P.personnelRead }],
  },
  {
  ...
  {
    label: "documents.nav",
    items: [{ title: "documents.nav", href: "/admin/documents", icon: FileCheck, permission: DOCUMENTS_P.documentsRead }],
  },
  {
    label: "booking.nav",
    items: [{ title: "booking.nav", href: "/admin/bookings", icon: CalendarDays, permission: BOOKING_P.bookingRead }],
  },
  {
